    ...
    <>
         ...
         {/* <div className='w-fit h-fit' id={id}> */}
           <AnimatePresence>
            ...
            <div className=''> 
                <h3 className={`font-semibold uppercase break-words ${open ? 'text-[1rem]' : 'text-[0.8rem]'} pb-4`}>{title}</h3>
                <p className={` font-light ${open ? 'text-[1rem]' : 'text-[0.75rem] '}`}> {description}</p>
          </div>
