        ...
        <div className='flex h-[100%] w-[100%]  gap-4 flex-col text-background' >
           ...
           Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International License
            ...
            <div className='flex gap-4'>
             <Image src='/assets/ifra.png' alt='logo' width={100} height={100} className=' sm:p-4 object-contain h-fit' />

             <Image src='/assets/ifra2.png'alt='logo' width={100} height={100} className=' sm:p-4 object-contain h-fit' />

             <Image src='/assets/CNRS.png'alt='logo' width={100} height={100} className=' sm:p-4 pt-4 object-contain h-fit' />
          ...
          <div className='items-center  h-fit flex'>
            <Image src={footer.logo.url} alt='logo' width={50} height={50} className=' sm:p-4 object-contain h-fit' />
