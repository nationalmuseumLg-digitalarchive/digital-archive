      ...
      <div className='w-fit h-fit'> 
        <Image
          ...
          <div className='pb-8 flex flex-col gap-2'>
            ...
            <Link className='border-background uppercase font-semibold text-sm  hover:text-[#006600]' href={'/manuscripts/k.c_murray'} >
                K.C. MURRAY MANUSCRIPTS
            </Link>

            <Link className='border-background uppercase font-semibold text-sm  hover:text-[#006600]' href={'/manuscripts/benin_expeditions'} >
              BENIN EXPEDITIONS
            </Link>
