...
const IntelligenceReports = async ({ searchParams }) => {
      ...
      <div className="w-[100vw] min-h-[100vh] h-[100%] font-montserrat flex justify-between bg-background border-black border-t-[1px] flex-row p-8 ">
        <div className="flex justify-between flex-col">
          <div className="h-fit w-fit flex flex-col gap-4 text-[0.75rem] sm:text-[1rem]">
            <h2 className="text-[2rem] sm:text-[3rem] text-primary font-bold pb-2 uppercase">
            ...
            <div className="w-fit h-fit">
              <Image
                ...
                width={300}
                height={200}
                src="/assets/Intelligence.webp"
                alt="maps"
              />
            </div>

            <p>
              Intelligence reports are documents or briefings that provide insights, analyses, and
